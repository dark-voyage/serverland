...
exports.form_complete =
    Markup.inlineKeyboard([
        ...
        [
            Markup.urlButton(`Check pending invitations`, `https://github.com/orgs/genestatic/people/pending_invitations`)
        ],
        [
            Markup.urlButton(`Check pending collaborators`, `https://github.com/orgs/genestatic/pending_collaborators`)
        ]
    ])
...
exports.audio =
    Markup.inlineKeyboard([
        [
            Markup.urlButton(`Upload your own music & audio!`, `https://t.me/genemator_bot`)
        ],
        [
            Markup.urlButton(`Community Channel`, `https://t.me/genemators`)
        ]
